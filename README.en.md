...
![Windows 0.14.0](https://img.shields.io/badge/Windows_10%2F11-0.14.0-0078D6?logo=windows&logoColor=white)
...
|---|---|---|---|---|
| **Windows 10/11** · installer | `SweetWhisper-Setup.exe` | 19.3 MB | [download](https://sweetwhisper.app/dl/SweetWhisper-Setup.exe) | [v0.14.0](../../releases/tag/v0.14.0) |
| **Windows 10/11** · portable | `SweetWhisper-Portable.zip` | 37.3 MB | [download](https://sweetwhisper.app/dl/SweetWhisper-Portable.zip) | [v0.14.0](../../releases/tag/v0.14.0) |
| **Android 9+** · APK | `SweetWhisper.apk` | 36.2 MB | [download](https://sweetwhisper.app/dl/SweetWhisper.apk) | [android-v3.30](../../releases/tag/android-v3.30) |
