...
![Windows 0.15.0](https://img.shields.io/badge/Windows_10%2F11-0.15.0-0078D6?logo=windows&logoColor=white)
...
|---|---|---|---|---|
| **Windows 10/11** · installer | `SweetWhisper-Setup.exe` | 19.8 MB | [download](https://sweetwhisper.app/dl/SweetWhisper-Setup.exe) | [v0.15.0](../../releases/tag/v0.15.0) |
| **Windows 10/11** · portable | `SweetWhisper-Portable.zip` | 38.0 MB | [download](https://sweetwhisper.app/dl/SweetWhisper-Portable.zip) | [v0.15.0](../../releases/tag/v0.15.0) |
