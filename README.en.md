...
|---|---|---|---|---|
| **Windows 10/11** · installer | `SweetWhisper-Setup.exe` | 18.6 MB | [download](https://sweetwhisper.app/dl/SweetWhisper-Setup.exe) | [v0.12.0](../../releases/tag/v0.12.0) |
| **Windows 10/11** · portable | `SweetWhisper-Portable.zip` | 35.7 MB | [download](https://sweetwhisper.app/dl/SweetWhisper-Portable.zip) | [v0.12.0](../../releases/tag/v0.12.0) |
